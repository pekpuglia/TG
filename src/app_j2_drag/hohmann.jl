...
N = 100
##
planner, transfer = n_impulse_transfer(sc_model, X1, X2, tfprime, N, 2, false, false);
...
planner, transfer = n_impulse_transfer(sc_model, X1, X2, tfprime, N, 2, true, true);
...
## 3 impulses
planner, transfer = n_impulse_transfer(sc_model, X1, X2, tfprime, N, 3, true, true);
