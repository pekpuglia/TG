...
##
serialize("./src/app_j2_drag/c2c_ICI", solved_transfer)
###########################################################################################################################################
###########################################################################################################################################
###########################################################################################################################################
...
##
solved_transfer_2 = deserialize("./src/app_j2_drag/c2c_CICIC")
solved_transfer_2 = rediscretize_transfer(solved_transfer_2, N, RK8)
null_transfer_2 = add_null_impulse(solved_transfer_2, tspan_ppdot_stm)
