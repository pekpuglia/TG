...
\title{Primer Vector Analysis of Optimal Impulsive Orbital Maneuvers Under Conservative and Non-Conservative Perturbations}
% Orientador
...
\bosscourse{Profa.~Dra.}{Maísa de Oliveira Terra}
...
\FRDitapalavrasautor{Manobra Orbital; Controle ótimo; Hamiltoniano}
\FRDitapalavrasresult{}
%Exemplo no caso de graduação (TG):
\FRDitapalavraapresentacao{Trabalho de Graduação, ITA, São José dos Campos, 2025. \NumPenultimaPagina\ páginas.}
