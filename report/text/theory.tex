...
\begin{equation}
    ...
    \end{bmatrix}
\end{equation}
which is linear in the costate variables. Therefore, the adjoint equations admit a solution through the form of a state transition matrix \(\Phi(t - t_0)\) such that
\begin{equation}
    \begin{bmatrix}
        \lambda_r(t) \\ \lambda_v(t)
    \end{bmatrix} = \Phi(t - t_0) \begin{bmatrix}
        \lambda_r(t_0) \\ \lambda_v(t_0)
    \end{bmatrix}.
\end{equation}
