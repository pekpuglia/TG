...
The generation of thrust \(F\) is tied to the consumption of propellant, \(-\dot m\), according to some propulsion model; this work relies on the impulsive propulsion model.
