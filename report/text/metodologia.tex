...
\begin{tikzpicture}
    \node (init) [startstop] {Initial condition};
    ...
    \node (final) [process, right = of dots2] {Final condition};
...
\begin{tikzpicture}
    ...
    \node (opt) [startstop, right = of diag] {Local optimum};
    \node (cont) [startstop, below = of diag] {More impulses};
