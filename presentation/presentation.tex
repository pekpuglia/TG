        ...
        \begin{column}{0.3\linewidth}
            ...
            \only<5>{
                \begin{itemize}
                    ...
                    \item Extra impulse: plane change in middle of maneuver
...
\begin{frame}
    \frametitle{J2+Drag Primer Vector}

    \begin{itemize}
        \item Non-conservative model: only ODE method for primer vector calculation
        \item In practice:
    \end{itemize}
    ...
    \begin{itemize}
        \item STM method is indistinguishable from ODE method
        \item \(\lVert \mathbf{A}_p - \mathbf{A}_\delta \rVert _\infty < 10^{-11}\)
...
\begin{frame}
    ...
    \begin{itemize}
        \item Accomplished optimization of LEO impulsive maneuvers;
        \item J2 affects nature of trajectories and maneuvers significantly;
        \item In the time scales considered, drag does not;
        \item Extended primer vector theory to perturbed models;
        \item Three proposed primer vector calculation methods compared and validated
        \item Future works
        \begin{itemize}
            \item Longer time spans
            \item Drag primer vector conjecture: differentiate STM and ODE methods
            \item Estimate cost lower bound 
        \end{itemize}
    \end{itemize}
