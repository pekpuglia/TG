...
%TODO revisão bibliográfica, mais contexto, arrumar referências, erro de posição final
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item State transition matrix (STM) for variational perturbations
            \begin{equation}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Mathematics: minimum is unattainable with bounded acceleration\pause
        \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \end{itemize}\pause
        \item Primer vector algorithm can offer >100x increase in performance\pause
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Estimate cost lower bound} 
        \end{itemize}
    \end{itemize}
    \pause
    \begin{center}
